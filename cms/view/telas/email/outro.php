<script>
    enviarFormulario("frmEmailOutro","../../router.php?controller=email&modo=enviar");
</script>
<div class="formulario_modal">
    <form id="frmEmailOutro" name="frmEmailOutro">
           <div class="row">
            <div class="col-100">
                 <label for="txtAssunto">Destinatario:</label>
            </div>
        </div>
        <div class="row">
            <div class="col-100">
                <input type="text" id="txtDestinatario" name="txtDestinatario" value="<?=$nome?>" placeholder="Digite o destinatario do e-mail..." required>
            </div>
        </div>
        <div class="row">
            <div class="col-100">
